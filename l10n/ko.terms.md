...
② 본 약관 제6조 제3항에 정해진 바에 의하여 자격상실 통보를 받은 회원은 기적립된 가용 포인트를 자격상실 통보일로부터 7일(잔여포인트소기간) 이내에 본 약관이 정하는 바에 따라 현금 환급 및 제휴 컨텐츠를 구매할 수 있습니다. 잔여 포인트 해소기간까지 사용하지 않은 포인트는 자동으로 소멸됩니다.
